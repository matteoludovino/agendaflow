...
export const metadata: Metadata = {
  ...
  description:
    "Crie sua página de agendamento em minutos. Aceite clientes 24h por dia, sem idas e vindas de mensagem.",
}
...
const FEATURES = [
  {
    ...
    description:
      "Seu cliente acessa, escolhe o serviço e agenda sozinho — sem você precisar responder uma mensagem.",
  },
  {
    icon: Clock,
    title: "Controle de disponibilidade",
    description:
      "Defina seus horários, bloqueie datas e configure intervalos entre atendimentos com total flexibilidade.",
  },
  {
    icon: Bell,
    title: "Lembretes automáticos",
    description:
      "E-mails de confirmação e lembrete enviados automaticamente. Menos faltas, mais previsibilidade.",
  },
  {
    icon: BarChart2,
    title: "Painel de métricas",
    description:
      "Acompanhe seus agendamentos, receita estimada e taxa de ocupação em um único lugar.",
  },
  {
    icon: Globe,
    title: "Link personalizado",
    description:
      "Compartilhe agendaflow.com/seunome no Instagram, WhatsApp ou cartão de visita. Simples assim.",
  },
  {
    icon: Shield,
    title: "Pagamentos pelo Stripe",
    description:
      "Cobranças processadas com segurança. Sem burocracia, sem taxa de adesão, sem surpresas.",
  },
]
...
const HOW_IT_WORKS = [
  {
    ...
    description:
      "Cadastre o que você oferece, defina preços, duração e configure sua disponibilidade semanal.",
  },
  {
    step: "02",
    title: "Compartilhe seu link",
    description:
      "Seu cliente acessa sua página pública e escolhe o melhor horário disponível para ele.",
  },
  {
    step: "03",
    title: "Apareça e atenda",
    description:
      "Você recebe a notificação, o cliente recebe a confirmação. Sem mensagens de vai e vem.",
  },
]
...
const TESTIMONIALS = [
  {
    name: "Camila Rocha",
    role: "Nail designer",
    text: "Antes eu passava 30 minutos por dia confirmando horários no WhatsApp. Agora meus clientes agendam sozinhos às 2 da manhã se quiserem.",
    rating: 5,
  },
  {
    name: "Rafael Mendes",
    role: "Personal trainer",
    text: "Minha taxa de no-show caiu pela metade depois dos lembretes automáticos. Não consigo mais imaginar trabalhar sem o AgendaFlow.",
    rating: 5,
  },
  {
    name: "Dra. Priya Alves",
    role: "Nutricionista",
    text: "Simples, rápido e bonito. Meus clientes adoram o link de agendamento. Parece muito mais profissional do que o Google Forms.",
    rating: 5,
  },
]
...
export default function HomePage() {
  return (
    <div
      className={cn(sora.variable, "min-h-screen bg-white text-zinc-900")}
    ...
    >
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-zinc-100">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden items-center gap-8 md:flex">
            <Link href="#funcionalidades" className="text-sm text-zinc-500 transition-colors hover:text-zinc-900">
              Funcionalidades
            </Link>
            <Link href="#como-funciona" className="text-sm text-zinc-500 transition-colors hover:text-zinc-900">
              Como funciona
            </Link>
            <Link href="#planos" className="text-sm text-zinc-500 transition-colors hover:text-zinc-900">
              Planos
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden bg-zinc-950 pt-32 pb-24">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          <div
            className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-4 py-1.5"
          >
          ...
          <h1
            className="animate-fade-up delay-100 gradient-text text-5xl font-extrabold leading-tight tracking-tight sm:text-6xl md:text-7xl"
          >
            Agendamentos no piloto automático
          </h1>

          <p
            className="animate-fade-up delay-200 mx-auto mt-6 max-w-2xl text-lg text-zinc-400 leading-relaxed"
          >
            Crie sua página de agendamento profissional em minutos. Seus clientes marcam sozinhos,
            você recebe a confirmação. Simples assim.
          </p>

          <div className="animate-fade-up delay-300 mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link
              href="/register"
              className="group flex items-center gap-2 rounded-lg bg-indigo-600 px-6 py-3 text-base font-semibold text-white transition-all hover:bg-indigo-500"
            >
            ...
            <Link
              href="/login"
              className="rounded-lg border border-white/10 px-6 py-3 text-base font-semibold text-zinc-300 transition-colors hover:border-white/20 hover:text-white"
            >
              Já tenho conta
            </Link>
          </div>

          <p className="animate-fade-up delay-400 mt-6 text-sm text-zinc-600">
            Grátis para sempre nos primeiros 3 serviços · Sem cartão de crédito
          </p>
        </div>
          ...
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-zinc-900 shadow-2xl shadow-black/50">
            <div className="flex items-center gap-2 border-b border-white/5 bg-zinc-900/80 px-4 py-3">
              ...
              <div className="mx-auto flex h-6 w-48 items-center justify-center rounded-md bg-white/5 px-3">
                <span className="text-xs text-zinc-500">agendaflow.com/seunome</span>
              </div>
            </div>
      ...
      <section className="border-b border-zinc-100 bg-zinc-50 py-8">
        <div className="mx-auto max-w-5xl px-6">
          <p className="mb-6 text-center text-sm font-semibold uppercase tracking-widest text-zinc-400">
            Adorado por profissionais autônomos do Brasil
          </p>
          <div className="flex flex-wrap items-center justify-center gap-8 text-zinc-400">
            {["Cabeleireiros", "Personal trainers", "Nutricionistas", "Psicólogos", "Nail designers", "Coaches"].map(
              (p) => (
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-zinc-500">
              Pensado para autônomos que precisam de uma solução completa, mas não têm tempo de aprender
              uma ferramenta complexa.
            </p>
          </div>
          ...
          <div className="relative grid gap-8 sm:grid-cols-3">
            ...
            {HOW_IT_WORKS.map(({ step, title, description }) => (
              <div key={step} className="relative flex flex-col items-center text-center">
                <div className="mb-5 flex h-16 w-16 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-2xl font-bold text-indigo-400">
                  {step}
                </div>
            ...
            {PLAN_ORDER.map((planId) => {
              ...
              return (
                <div
                  key={planId}
                  className={cn(
                    "card-hover relative flex flex-col rounded-2xl border p-7",
                    isFeatured
                ...
                >
                  {isFeatured && (
                    <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full bg-amber-400 px-3 py-0.5 text-xs font-bold text-amber-900">
                      Mais popular
                    </span>
                  )}

                  <div className="mb-6">
                    <h3 className={cn("text-lg font-bold", isFeatured ? "text-white" : "text-zinc-900")}>
                      {plan.name}
                    </h3>
                    <div className="mt-2 flex items-baseline gap-1">
                      {plan.price === 0 ? (
                        <span className={cn("text-4xl font-extrabold", isFeatured ? "text-white" : "text-zinc-900")}>
                          Grátis
                        </span>
                      ) : (
                        <>
                          ...
                          <span className={cn("text-sm", isFeatured ? "text-indigo-200" : "text-zinc-400")}>/mês</span>
                        </>
                      )}
                    </div>
                    <p className={cn("mt-1 text-sm", isFeatured ? "text-indigo-200" : "text-zinc-500")}>
                      {plan.description}
                    </p>
                  </div>
                  ...
                  <ul className="mb-8 flex-1 space-y-2.5">
                    {plan.features.map((f) => (
                      <li key={f} className="flex items-start gap-2.5 text-sm">
                        <Check
                          className={cn("mt-0.5 h-4 w-4 shrink-0", isFeatured ? "text-indigo-200" : "text-indigo-600")}
                          strokeWidth={2.5}
                        />
      ...
      <section className="relative overflow-hidden bg-zinc-950 py-24 text-white">
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center">
          <h2 className="text-4xl font-extrabold tracking-tight sm:text-5xl">
            Pare de perder tempo com WhatsApp.{" "}
            <span className="gradient-text">Comece hoje.</span>
          </h2>
          <p className="mx-auto mt-6 max-w-xl text-zinc-400">
            Crie sua conta gratuita em menos de 2 minutos e tenha sua página de agendamento no ar ainda hoje.
          </p>
          <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link
              href="/register"
              className="group flex items-center gap-2 rounded-xl bg-indigo-600 px-8 py-3.5 text-base font-bold text-white transition-all hover:bg-indigo-500"
            >
              Criar conta grátis
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            ...
            <p className="text-sm text-zinc-400">
              © {new Date().getFullYear()} AgendaFlow · Feito no Brasil 🇧🇷
            </p>
          </div>
        </div>
      </footer>
